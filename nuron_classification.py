...
for data in trial_data:
    if neural_network.commit(data) < 0.5:
        position_tokyo[0].append(data[1] + refer_point1)
        position_tokyo[1].append(data[0] + refer_point0)
    else:
        position_kanagawa[0].append(data[1] + refer_point1)
        position_kanagawa[1].append(data[0] + refer_point0)
